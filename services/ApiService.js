export default ($axios, $auth) => ({
  ...
  savePatientAmu(patient) {
    if (!$auth.loggedIn) {
      return
    }

    return $axios.$post(`/patient/assurer/amu`, patient, {
      headers: {
        Authorization: `Bearer ${$auth.token}`,
      },
    })
  ...
  async loardFacture(filename) {
    await $axios
      .$get(`/downloadFile/facture/${filename}`, {
        headers: {
          Authorization: `Bearer ${$auth.token}`,
        },
        responseType: 'arraybuffer',
  ...
  searchAllPaiementDatePage(page, date, s) {
    ...
    return $axios.$get(
      `/encaissement/etat/date/search/page/${page}/${date}/${s}`,
      {
        headers: {
          Authorization: `Bearer ${$auth.token}`,
        },
  ...
  searchAllDecaissementCaisseDatePage(date, page, s) {
    ...
    return $axios.$get(
      `/decaissements/caisse/date/search/page/${date}/${page}/${s}`,
      {
        headers: {
          Authorization: `Bearer ${$auth.token}`,
        },
  ...
  async loardDocumentAtt(filename) {
    await $axios
      .$get(`/downloadFile/attachment/${filename}`, {
        headers: {
          Authorization: `Bearer ${$auth.token}`,
        },
        responseType: 'arraybuffer',
