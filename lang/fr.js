export default {
    ...
    facture: {
        ...
        newPro: "Nouveau facture proforma",
    ...
    paiement: {
        ...
        printCaisse: "Imprimer l'etat de la caisse",
        printReserve: "Imprimer l'etat de la reserve",
    ...
    decaissement: {
        title: "Decaissements",
        new: "Nouveau decaissement",
        edit: "Modifier un decaissement",
        update: "Modifier",
        search: "Recherche...",
        subtitle: "Voir votre decaissement",
        add: "Ajouter un decaissement",
        form: {
            caisse: "Caisse",
            ...
            motif: "Motif",
            montant: "Montant",
            dateDecaissement: "Date Decaissement",
        },
        table: {
            num: "N°",
            caisse: "Caisse",
            ...
            dateDecaissement: "Date Decaissement",
            action: "Action",
            per_page: "decaissement par page",
            page_text: "de",
        },
    },
    depenseReserve: {
        title: "depenses reserve",
        new: "Nouveau depense",
        edit: "Modifier un depense",
        update: "Modifier",
        search: "Recherche...",
        subtitle: "Voir votre depense",
        add: "Ajouter un depense",
        form: {
            motif: "Motif",
            montant: "Montant",
    ...
    reserve: {
        title: "Reserves",
        new: "Nouveau reserve",
        edit: "Modifier une reserve",
        update: "Modifier",
        search: "Recherche...",
        subtitle: "Voir votre reserve",
    ...
    validations: {
        ...
        time: {
            ...
            min: "L'heure doit contenir au moins {length} caractères.",
            max: "L'heure doit contenir au plus {length} caractères.",
        },
        totalRemis: {
        ...
        motif: {
            ...
            min: "Le motif  doit contenir au moins {length} caractères.",
