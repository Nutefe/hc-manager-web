export default {
  ...
  logins: {
    ...
    logout: 'Deconnexion',
    accessDenied:
      "Accès refusé vous n'avez pas l'autorisation pour accéder à cette application",
  ...
  patient: {
    ...
    addAssAmu: 'Ajouter un patient assurer AMU',
  ...
  validations: {
    ...
    montant: {
      ...
      equalmore:
        'La somme a paye doit etre inferieur ou egale au montant de la facture',
    },
    description: {
