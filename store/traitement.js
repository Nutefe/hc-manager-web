...
export const mutations = {
  ...
  SET_ALL_TRAITEMENTS_FICHE(state, allTraitementsFiche) {
    state.allTraitementsFiche = allTraitementsFiche
  },
...
export const actions = {
  ...
  fetchAllTraitementFiche({ commit }, id) {
    // if
    return this.$api.getTraitementByFiche(id).then((data) => {
      commit('SET_ALL_TRAITEMENTS_FICHE', data)
    })
  },
...
export const getters = {
  ...
  getTraitementById: (state) => (id) => {
    ...
    return traitements.find((art) => art.id === id)
  },
}
